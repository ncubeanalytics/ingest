...
* Fix potentially uncaught errors on tokio tasks for sending messages to kafka

## 0.12.0 - 2025-01-14

### Changed

* Change configuration to support arbitrary librdkafka properties read from a file, not just
  sasl password
